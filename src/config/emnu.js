export const DataType = { Number: 0, String: 1, Date: 2 }
//标签类型
export const LabelType = { control: 0, variable: 1, condition: 2 }
//取值方法
export const ValueMethod = { Const: 0, Formula: 1 }
//关联规则
export const RelateRule = { 赋值: 'assignment', 加载地图: 'loadmap', 加载子下拉框: 'loadsubselect' }
//数据源类型
export const DataSourceType = { Dict: 0, Custom: 1, DataApi: 2 }
//关联类型
export const RelateType = { combine: 0, visibility: 1, address: 2, location:3}
//运算符
export const Operation = { Plus: 0, Minus: 1, Multiply: 2, Divide: 3, LeftParentheses: 4, RightParentheses: 5, }
//验证类型
...
export const FormulaExampleData = [
    {
        name: '抵押价值单价',
